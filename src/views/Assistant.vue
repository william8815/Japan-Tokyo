...
import { 
  ...
  MapPin, HelpCircle, ChevronDown, Check, QrCode, Image as ImageIcon, Plus, Trash2, X, Pencil, Upload
...
const handleSaveVoucher = () => {
  if (!voucherTitle.value || !voucherImage.value) return // 簡單驗證
...
<template>
  <div class="space-y-6 pb-24">
    ...
    <div v-if="activeTab === 'vouchers'" class="space-y-6 animate-in fade-in duration-500 px-1">
      ...
      <!-- 新增按鈕區 (Empty State or Top Action) -->
    ...
    <Teleport to="body">
      ...
      <!-- Delete Confirmation Modal (Reuse style) -->
